...
sidebar: sidebar 
keywords:  
summary: Você pode atualizar o Unified Manager 9,7 ou 9,8 para 9,9 baixando e executando o arquivo de instalação na plataforma Windows. 
---
...
[role="lead"]
Você pode atualizar o Unified Manager 9,7 ou 9,8 para 9,9 baixando e executando o arquivo de instalação na plataforma Windows.
