...
** Protegido por
+
Apresenta o tipo de proteçãoão utilizado para o volume selecionado. Esse campo também fornece um link que redireciona você para a página de relacionamentos com suas relações de recuperação de desastres de VM de armazenamento. O link só é aplicável às relações constituintes.
